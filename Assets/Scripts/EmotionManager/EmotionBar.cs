...
public class EmotionBar : MonoBehaviour
{
    ...
    {
        GameObject.Find("EmotionManager").GetComponent<EmotionController>().OnSatisfactionIncreased += SetSatisfaction;
    }
    ...
    private void Start()
    {
        ...
        emotionController = GameObject.Find("EmotionManager").GetComponent<EmotionController>();
